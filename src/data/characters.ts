...
export const PIXAR_CHARACTERS: PixarCharacter[] = [
  {
    ...
    themeColor: '#FFD700',
    accentColor: '#FFA500',
    bgImage: '/assets/pixar/bg/character1.webp',
    characterImage: '/assets/pixar/nobg/character1.webp',
  ...
  },
  {
    ...
    themeColor: '#00F0FF',
    accentColor: '#7000FF',
    bgImage: '/assets/pixar/bg/character2.webp',
    characterImage: '/assets/pixar/nobg/character2.webp',
  ...
  },
  {
    ...
    themeColor: '#00FF9D',
    accentColor: '#00B4D8',
    bgImage: '/assets/pixar/bg/character3.webp',
    characterImage: '/assets/pixar/nobg/character3.webp',
  ...
  },
  {
    ...
    themeColor: '#FF3366',
    accentColor: '#FF6B00',
    bgImage: '/assets/pixar/bg/character4.webp',
    characterImage: '/assets/pixar/nobg/character4.webp',
  ...
  },
  {
    ...
    themeColor: '#D946EF',
    accentColor: '#8B5CF6',
    bgImage: '/assets/pixar/bg/character5.webp',
    characterImage: '/assets/pixar/nobg/character5.webp',
